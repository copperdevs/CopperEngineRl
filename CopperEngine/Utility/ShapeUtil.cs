...
public static class ShapeUtil
{
    ...
    public static void DrawLine(Vector2 startPos, Vector2 endPos, float thick, Color color) =>
    ...
    public static void DrawLineBezierQuad(Vector2 startPos, Vector2 endPos, Vector2 controlPos, float thick,
        Color color) => Raylib.DrawLineBezierQuad(startPos, endPos, controlPos, thick, color);

    /// <inheritdoc cref="Raylib.DrawLineBezierCubic"/>
    public static void DrawLineBezierCubic(Vector2 startPos, Vector2 endPos, Vector2 startControlPos,
    ...
    public static void DrawCircleSector(Vector2 center, float radius, float startAngle, float endAngle, int segments,
        Color color) => Raylib.DrawCircleSector(center, radius, startAngle, endAngle, segments, color);

    /// <inheritdoc cref="Raylib.DrawCircleSectorLines"/>
    public static void DrawCircleSectorLines(Vector2 center, float radius, float startAngle, float endAngle,
    ...
    public static void DrawRing(Vector2 center, float innerRadius, float outerRadius, float startAngle, float endAngle,
        int segments, Color color) =>
        Raylib.DrawRing(center, innerRadius, outerRadius, startAngle, endAngle, segments, color);

    /// <inheritdoc cref="Raylib.DrawRingLines"/>
    public static void DrawRingLines(Vector2 center, float innerRadius, float outerRadius, float startAngle,
        float endAngle, int segments, Color color) => Raylib.DrawRingLines(center, innerRadius, outerRadius, startAngle,
    ...
    public static void DrawRectangle(Rectangle rec, Vector2 origin, float rotation, Color color) =>
        Raylib.DrawRectanglePro(rec, origin, rotation, color);

    /// <inheritdoc cref="Raylib.DrawRectangleGradientEx"/>
    public static void DrawRectangleGradient(Rectangle rec, Color col1, Color col2, Color col3, Color col4) =>
    ...
    public static void DrawRectangleLines(Rectangle rec, float lineThick, Color color) =>
    ...
    public static void DrawRectangleRoundedLines(Rectangle rec, float roundness, int segments, float lineThick,
        Color color) => Raylib.DrawRectangleRoundedLines(rec, roundness, segments, lineThick, color);
    ...
    public static void DrawPolyLines(Vector2 center, int sides, float radius, float rotation, float lineThick,
        Color color) => Raylib.DrawPolyLinesEx(center, sides, radius, rotation, lineThick, color);
    ...
    public static unsafe bool CheckCollisionPointPoly(Vector2 point, Vector2* points, int pointCount) =>
        Raylib.CheckCollisionPointPoly(point, points, pointCount);
