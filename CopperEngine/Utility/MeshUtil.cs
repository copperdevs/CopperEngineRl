...
public static class MeshUtil
{
    ...
    public static unsafe void UpdateBuffer(Mesh mesh, int index, void* data, int dataSize, int offset) =>
    ...
    public static void Draw(Mesh mesh, Material material, Matrix4x4 transform) =>
        Raylib.DrawMesh(mesh, material, transform);

    /// <inheritdoc cref="Raylib.DrawMeshInstanced(Mesh, Material, Matrix4x4[], int)"/>
    public static void DrawInstanced(Mesh mesh, Material material, Matrix4x4[] transforms, int instances) =>
