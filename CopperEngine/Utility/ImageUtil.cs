...
public static class ImageUtil
{
    ...
    public static Image Load(string path, int width, int height, PixelFormat format, int headerSize) =>
        Raylib.LoadImageRaw(path, width, height, format, headerSize);
    ...
    public static unsafe Color* LoadPalette(Image image, int maxPaletteSize, int* colorCount) =>
    ...
    public static Image GenGradientH(int width, int height, Color left, Color right) =>
        Raylib.GenImageGradientH(width, height, left, right);

    /// <inheritdoc cref="Raylib.GenImageGradientV"/>
    public static Image GenGradientV(int width, int height, Color top, Color bottom) =>
    ...
    public static Image Text(Font font, string text, float fontSize, float spacing, Color color) =>
        Raylib.ImageTextEx(font, text, fontSize, spacing, color);
    ...
    public static void
        ResizeCanvas(ref Image image, int newWidth, int newHeight, int offsetX, int offsetY, Color color) =>
    ...
    public static Rectangle GetAlphaBorder(Image image, float threshold) =>
    ...
    public static void DrawPixel(ref Image dst, int posX, int posY, Color color) =>
        Raylib.ImageDrawPixel(ref dst, posX, posY, color);
    ...
    public static void DrawPixel(ref Image dst, Vector2 pos, Color color) =>
        Raylib.ImageDrawPixelV(ref dst, pos, color);
    ...
    public static void DrawLine(ref Image dst, int startPosX, int startPosY, int endPosX, int endPosY, Color color) =>
        Raylib.ImageDrawLine(ref dst, startPosX, startPosY, endPosX, endPosY, color);
    ...
    public static unsafe void DrawCircleLines(Image* dst, int centerX, int centerY, int radius, Color color) =>
        Raylib.ImageDrawCircleLines(dst, centerX, centerY, radius, color);

    /// <inheritdoc cref="Raylib.ImageDrawCircleLinesV"/>
    public static unsafe void DrawCircleLines(Image* dst, Vector2 center, int radius, Color color) =>
    ...
    public static void DrawRectangle(ref Image dst, int posX, int posY, int width, int height, Color color) =>
        Raylib.ImageDrawRectangle(ref dst, posX, posY, width, height, color);
    ...
    public static void DrawRectangle(ref Image dst, Vector2 pos, Vector2 size, Color color) =>
        Raylib.ImageDrawRectangleV(ref dst, pos, size, color);
    ...
    public static void DrawRectangleRec(ref Image dst, Rectangle rec, Color color) =>
        Raylib.ImageDrawRectangleRec(ref dst, rec, color);
    ...
    public static void DrawRectangleLines(ref Image dst, Rectangle rec, int thick, Color color) =>
        Raylib.ImageDrawRectangleLines(ref dst, rec, thick, color);
    ...
    public static void Draw(ref Image dst, Image src, Rectangle srcRec, Rectangle dstRec, Color color) =>
        Raylib.ImageDraw(ref dst, src, srcRec, dstRec, color);
    ...
    public static void DrawText(ref Image dst, Font font, string text, Vector2 pos, int fontSize, float spacing,
        Color color) => Raylib.ImageDrawTextEx(ref dst, font, text, pos, fontSize, spacing, color);
}