...
public static class FontUtil
{
    ...
    public static Font
        LoadFromMemory(string fileType, byte[] fileData, int fontSize, int[] fontChars, int glyphCount) =>
        Raylib.LoadFontFromMemory(fileType, fileData, fontSize, fontChars, glyphCount);
    ...
    public static void DrawText(Font font, string text, Vector2 pos, float fontSize, float spacing, Color color) =>
    ...
    public static void DrawText(Font font, string text, Vector2 pos, Vector2 origin, float rotation, float fontSize,
        float spacing, Color color) => Raylib.DrawTextPro(font, text, pos, origin, rotation, fontSize, spacing, color);

    /// <inheritdoc cref="Raylib.DrawTextCodepoint"/>
    public static void DrawTextCodepoint(Font font, int codepoint, Vector2 pos, float fontSize, Color color) =>
        Raylib.DrawTextCodepoint(font, codepoint, pos, fontSize, color);
    ...
    public static Vector2 MeasureText(Font font, string text, float fontSize, float spacing) =>
