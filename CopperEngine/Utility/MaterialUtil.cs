...
public static class MaterialUtil
{
    ...
    public static unsafe Material* LoadMaterials(sbyte* fileName, int* materialCount) =>
    ...
    public static Texture2D GetTexture(ref Model model, int materialIndex, MaterialMapIndex mapIndex) =>
        Raylib.GetMaterialTexture(ref model, materialIndex, mapIndex);

    /// <inheritdoc cref="Raylib.SetMaterialTexture(ref Material, MaterialMapIndex, Texture2D)"/>
    public static void SetTexture(ref Material material, MaterialMapIndex mapType, Texture2D texture) =>
    ...
    public static void
        SetTexture(ref Model model, int materialIndex, MaterialMapIndex mapIndex, ref Texture2D texture) =>
        Raylib.SetMaterialTexture(ref model, materialIndex, mapIndex, ref texture);
