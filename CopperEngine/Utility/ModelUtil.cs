...
public static class ModelUtil
{
    ...
    public static void DrawModel(Model model, Vector3 pos, float scale, Color color) =>
        Raylib.DrawModel(model, pos, scale, color);

    /// <inheritdoc cref="Raylib.DrawModel"/>
    public static void DrawModel(Model model, Vector3 pos, Vector3 rotationAxis, float rotationAngle, Vector3 scale,
        Color color) => Raylib.DrawModelEx(model, pos, rotationAxis, rotationAngle, scale, color);

    /// <inheritdoc cref="Raylib.DrawModelWires"/>
    public static void DrawModelWires(Model model, Vector3 pos, float scale, Color color) =>
        Raylib.DrawModelWires(model, pos, scale, color);

    /// <inheritdoc cref="Raylib.DrawModelWires"/>
    public static void DrawModelWires(Model model, Vector3 pos, Vector3 rotationAxis, float rotationAngle,
        Vector3 scale, Color color) => Raylib.DrawModelWiresEx(model, pos, rotationAxis, rotationAngle, scale, color);
    ...
    public static void DrawBillboard(Camera3D camera, Texture2D texture, Vector3 center, float size, Color color) =>
        Raylib.DrawBillboard(camera, texture, center, size, color);

    /// <inheritdoc cref="Raylib.DrawBillboardRec"/>
    public static void DrawBillboardRec(Camera3D camera, Texture2D texture, Rectangle source, Vector3 position,
        Vector2 size, Color color) => Raylib.DrawBillboardRec(camera, texture, source, position, size, color);

    /// <inheritdoc cref="Raylib.DrawBillboardPro"/>
    public static void DrawBillboardPro(Camera3D camera, Texture2D texture, Rectangle source, Vector3 position,
        Vector3 up, Vector2 size, Vector2 origin, float rotation, Color color) =>
        Raylib.DrawBillboardPro(camera, texture, source, position, up, size, origin, rotation, color);
    ...
    public static void DrawCircle3D(Vector3 center, float radius, Vector3 rotationAxis, float rotationAngle,
        Color color) => Raylib.DrawCircle3D(center, radius, rotationAxis, rotationAngle, color);
    ...
    public static void DrawCube(Vector3 pos, float width, float height, float length, Color color) =>
        Raylib.DrawCube(pos, width, height, length, color);
    ...
    public static void DrawCubeWires(Vector3 pos, float width, float height, float length, Color color) =>
        Raylib.DrawCubeWires(pos, width, height, length, color);
    ...
    public static void DrawSphere(Vector3 centerPos, float radius, int rings, int slices, Color color) =>
    ...
    public static void DrawCylinder(Vector3 pos, float radiusTop, float radiusBottom, float height, int slices,
        Color color) => Raylib.DrawCylinder(pos, radiusTop, radiusBottom, height, slices, color);

    /// <inheritdoc cref="Raylib.DrawCylinderEx"/>
    public static void DrawCylinder(Vector3 startPos, Vector3 endPos, float startRadius, float endRadius, int sides,
        Color color) => Raylib.DrawCylinderEx(startPos, endPos, startRadius, endRadius, sides, color);

    /// <inheritdoc cref="Raylib.DrawCylinderWires"/>
    public static void DrawCylinderWires(Vector3 pos, float radiusTop, float radiusBottom, float height, int slices,
        Color color) => Raylib.DrawCylinderWires(pos, radiusTop, radiusBottom, height, slices, color);

    /// <inheritdoc cref="Raylib.DrawCylinderWiresEx"/>
    public static void DrawCylinderWires(Vector3 startPos, Vector3 endPos, float startRadius, float endRadius,
        int sides, Color color) => Raylib.DrawCylinderWiresEx(startPos, endPos, startRadius, endRadius, sides, color);
    ...
    public static void DrawCapsuleWires(Vector3 startPos, Vector3 endPos, float radius, int slices, int rings,
        Color color) => Raylib.DrawCapsuleWires(startPos, endPos, radius, slices, rings, color);
    ...
    public static unsafe ModelAnimation* LoadAnimations(string path, ref uint animCount) =>
        Raylib.LoadModelAnimations(path, ref animCount);

    /// <inheritdoc cref="Raylib.UpdateModelAnimation"/>
    public static void UpdateAnimation(Model model, ModelAnimation anim, int frame) =>
    ...
    public static unsafe void UnloadAnimations(ModelAnimation* animations, uint count) =>
