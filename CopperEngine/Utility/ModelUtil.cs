...
public static class ModelUtil
{
    ...
    public static void DrawBillboard(Camera3D camera, Texture2D texture, Vector3 center, float size, Color color) => Raylib.DrawBillboard(camera, texture, center, size, color);
    
    /// <inheritdoc cref="Raylib.DrawBillboardRec"/>
    public static void DrawBillboardRec(Camera3D camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Color color) => Raylib.DrawBillboardRec(camera, texture, source, position, size, color);
    
    /// <inheritdoc cref="Raylib.DrawBillboardPro"/>
    public static void DrawBillboardPro(Camera3D camera, Texture2D texture, Rectangle source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color color) => Raylib.DrawBillboardPro(camera, texture, source, position, up, size, origin, rotation, color);
